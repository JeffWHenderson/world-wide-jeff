        ...
        return <html>
            ...
            <body style={{ margin: '0' }}>
                <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start' }}>
                    {
                        wordList.map((phrase: WordListItem, i: number) => (
                            <div key={i} style={{ display: 'flex', flexDirection: 'column', breakInside: 'avoid', pageBreakInside: 'avoid', width: '230px', height: '110px', border: '1px dotted grey' }}>
